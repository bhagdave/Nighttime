...
function scene:create( event )
    ...
    logo.y = display.contentCenterY - logo.height / 2        -- Assign the y value of the image.
    mainGroup:insert(logo)         -- Add the image to the display group.


    local nameDev = display.newText( "Game Over - You won", 0, 0, native.systemFontBold, 64 )		-- Create a new text in (0, 0) using the system font with a size of 64.
